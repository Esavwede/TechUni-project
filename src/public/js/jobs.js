  ...
  function createJobLinkElement( job_link )
  {
    try 
    {
      <p class="my-2"><a target="_blank" href="<%=post.link%>" 
      style=" border: 2px solid rgb(32, 104, 239);
      color: green; padding: 5px; border-radius: 4px; "> Apply </a> </p>
  ...
  function createReadMoreButton( job_id )
  {
    ...
    { 
      ...
      readMoreButton.classList.add('w-full sm:w-1/2 text-center rounded-xl p-3 my-3 bg-violet-800 text-white')
...
// sample 
const job = { id:'39232', title:'title', role:'role', location:'location', salary:'$2000', link:'https:www.google.com', content:'content' }
